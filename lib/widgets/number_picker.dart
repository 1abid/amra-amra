...
class NumberPicker extends StatelessWidget {
  ...
  Widget _integerListView(ThemeData themeData) {
    TextStyle defaultStyle = themeData.textTheme.body1.copyWith(
      color: Colors.white, fontWeight: FontWeight.w200,);
    TextStyle selectedStyle = themeData.textTheme.title.copyWith(
  ...
  void _animateIntWhenUserStoppedScrolling(int valueToSelect) {
    ...
    int currentlySelectedElementIndex = intScrollController.offset ~/
        itemExtent;
...
class _NumberPickerSelectedItemDecoration extends StatelessWidget {
  ...
  const _NumberPickerSelectedItemDecoration({Key key,
    @required this.axis,
